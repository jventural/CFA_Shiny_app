...
# Cargar todas las bibliotecas necesarias de una vez
...
# ——————————————————————————————————————————————————————————————
# Generar archivo de referencias en BibTeX
...
# ——————————————————————————————————————————————————————————————
# Función boot_cfa_plot adaptada para Posit Connect (sin ggpubr)
boot_cfa_plot <- function(df,
  ...
  suppressWarnings({
    #------------------------------------------------------------
    # 0. Cargar librerías necesarias (ya cargadas arriba, pero nos aseguramos)
    #------------------------------------------------------------
    library(ggplot2)
    library(tidyr)
    library(dplyr)
    ...
    # Combinar los tres paneles con patchwork (devuelve un ggplot)
...
server <- function(input, output, session) {
  ...
  # ReactiveValues para resultados del bootstrap
