...
# Cargar todas las bibliotecas necesarias (sin ggpubr)
suppressPackageStartupMessages({
  ...
  library(ggplot2)          # Necesario para semPlot y generación de gráficos
})
...
server <- function(input, output, session) {
  ...
  observeEvent(input$runBootstrap, {
    ...
    withProgress(message = "Ejecutando Bootstrap CFA...", value = 0, {
      ...
      # Llamada directa a boot_cfa_plot (ya no requiere ggpubr)
